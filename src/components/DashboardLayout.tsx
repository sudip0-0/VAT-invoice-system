    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      >
        ...
        <div className="flex h-14 items-center gap-3 border-b border-sidebar-border px-4">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-sidebar-primary font-bold text-sidebar-primary-foreground text-sm">
            V
          </div>
          {!collapsed && (
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border bg-card px-4">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span className="font-medium text-foreground">ABC Traders Pvt. Ltd.</span>
            <span className="hidden sm:inline">• PAN: 123456789</span>
          </div>
